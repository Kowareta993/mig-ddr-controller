...
#
# Generated by export_simulation on Sun Apr 10 22:25:09 +0430 2022
#
################################################################################
...
'-reset_run' switch to the './ddr_controller_0.sh' script.

./ddr_controller_0.sh -reset_run
...
./ddr_controller_0.sh -noclean_files

For more information on the script, please type './ddr_controller_0.sh -help'.
