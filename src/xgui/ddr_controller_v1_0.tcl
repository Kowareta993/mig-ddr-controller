...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "nCLIENT" -parent ${Page_0}
...
proc update_PARAM_VALUE.nCLIENT { PARAM_VALUE.nCLIENT } {
	# Procedure called to update nCLIENT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.nCLIENT { PARAM_VALUE.nCLIENT } {
	# Procedure called to validate nCLIENT
	return true
}
...
proc update_MODELPARAM_VALUE.nCLIENT { MODELPARAM_VALUE.nCLIENT PARAM_VALUE.nCLIENT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.nCLIENT}] ${MODELPARAM_VALUE.nCLIENT}
}
